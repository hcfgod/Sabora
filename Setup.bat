...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0Scripts\install_premake_windows.ps1"
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0Scripts\install_deps_windows.ps1"
