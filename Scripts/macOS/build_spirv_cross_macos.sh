...
echo "Building SPIRV-Cross (Debug) with $NUM_CORES cores..."
...
echo "Building SPIRV-Cross (Release) with $NUM_CORES cores..."
...
# On macOS with single-config generator, libraries are directly in build directory
LIBS_TO_COPY=(
